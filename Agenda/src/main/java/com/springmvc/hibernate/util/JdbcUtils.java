package com.springmvc.hibernate.util;
...
public class JdbcUtils {
    ...
    public static String ejecutaQuery2(String sql) {
    		StringBuilder sb = new StringBuilder();
        try {
        	
            ResultSet r = createStatement().executeQuery(sql);
    
			System.out.println("a ver" +r.toString());

            while (r.next()) {

				sb.append(r.getString(1)+" | "+r.getString(2)+" | "+r.getString(3)+"<br/>");
    ...
    //Se encarga de crear la conexión
